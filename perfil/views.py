...
class BasePerfil(View):
    ...
    def setup(self, *args, **kwargs):
        ...
        # criando atributo de instancia de perfil
        self.perfil = None
...
class Criar(BasePerfil):
    def post(self, *args, **kwargs):
        if not self.userform.is_valid() or not self.perfilform.is_valid():
            messages.error(
                self.request,
                'Existem erros no formulario de cadastro. Por favor verifique os campos'
        ...
        last_name = self.userform.cleaned_data.get('fast_name')
